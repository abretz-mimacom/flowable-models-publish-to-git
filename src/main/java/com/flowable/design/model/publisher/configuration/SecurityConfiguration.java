...
import com.flowable.autoconfigure.design.remote.RemoteHttpClientHttpRequestCustomizer;
...
public class SecurityConfiguration {
    ...
    //    @Bean
//    @ConditionalOnProperty(prefix = "flowable.design.deployment", name="deploy")
//    public RemoteHttpClientHttpRequestCustomizer deploymentCustomizer() {
//        return new PublishHttpClientHttpRequestCustomizer();
//    }
    @Bean
    @Order(10)
